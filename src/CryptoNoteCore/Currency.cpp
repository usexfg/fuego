...
*/
  ...
  CurrencyBuilder::CurrencyBuilder(Logging::ILogger &log) : m_currency(log)
  {
    ...
    m_currency.m_totalBurnedXfg = 0;
    m_currency.m_totalRebornXfg = 0;
    m_currency.m_totalSupply = parameters::MONEY_SUPPLY;
    m_currency.m_circulatingSupply = parameters::MONEY_SUPPLY;
    m_currency.m_blockRewardSupply = parameters::MONEY_SUPPLY;
