...
declare_id!("HneoqxfNZ8BrUbZHhtsQjFfipGFbeL3JauA5KfaNRE8N");
...
pub mod fuego_forecast {
    ...
    pub fn initialize_forecast(
        ...
        forecast_config.bump = ctx.bumps.forecast_config;
            ...
            EpochOutcome::Up | EpochOutcome::Down => {
                ...
                if losing_vault_total > 0 {
                    ...
                    if fee_amount > 0 {
                        ...
                        let seeds = &[b"forecast_config".as_ref(), &[ctx.accounts.forecast_config.bump]];
                        let signer = &[&seeds[..]];
                        ...
                        token::transfer(cpi_ctx1, treasury_share)?;
                        ...
                        token::transfer(cpi_ctx2, bonding_share)?;
