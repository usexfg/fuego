...
// Implementation of serialization methods for Eldernode Relayer messages

void StartEldernodeMonitoring::Request::serialize(CryptoNote::ISerializer &serializer) {
  serializer(bridgeContractAddress, "bridgeContractAddress");
  serializer(arbitrumRpcUrl, "arbitrumRpcUrl");
  serializer(networkId, "networkId");
}

void StartEldernodeMonitoring::Response::serialize(CryptoNote::ISerializer &serializer) {
  serializer(success, "success");
  serializer(status, "status");
  serializer(errorMessage, "errorMessage");
}

void StopEldernodeMonitoring::Request::serialize(CryptoNote::ISerializer &serializer) {
  // No fields to serialize
}

void StopEldernodeMonitoring::Response::serialize(CryptoNote::ISerializer &serializer) {
  serializer(success, "success");
  serializer(status, "status");
  serializer(errorMessage, "errorMessage");
}

void GetEldernodeStatistics::Request::serialize(CryptoNote::ISerializer &serializer) {
  // No fields to serialize
}

void GetEldernodeStatistics::Response::serialize(CryptoNote::ISerializer &serializer) {
  serializer(success, "success");
  serializer(isMonitoring, "isMonitoring");
  serializer(totalProofsProcessed, "totalProofsProcessed");
  serializer(totalProofsSubmitted, "totalProofsSubmitted");
  serializer(totalProofsFailed, "totalProofsFailed");
  serializer(lastProcessedBlock, "lastProcessedBlock");
  serializer(status, "status");
  serializer(errorMessage, "errorMessage");
}

void GenerateMerkleProof::Request::serialize(CryptoNote::ISerializer &serializer) {
  serializer(transactionHash, "transactionHash");
  serializer(blockHeight, "blockHeight");
}

void GenerateMerkleProof::Response::serialize(CryptoNote::ISerializer &serializer) {
  serializer(success, "success");
  serializer(merkleProof, "merkleProof");
  serializer(errorMessage, "errorMessage");
}

void GetValidationProof::Request::serialize(CryptoNote::ISerializer &serializer) {
  serializer(transactionHash, "transactionHash");
}

void GetValidationProof::Response::serialize(CryptoNote::ISerializer &serializer) {
  serializer(success, "success");
  serializer(validationProof, "validationProof");
  serializer(errorMessage, "errorMessage");
}

void SubmitToBridge::Request::serialize(CryptoNote::ISerializer &serializer) {
  serializer(starkProof, "starkProof");
  serializer(validationProof, "validationProof");
  serializer(recipientAddress, "recipientAddress");
}

void SubmitToBridge::Response::serialize(CryptoNote::ISerializer &serializer) {
  serializer(success, "success");
  serializer(bridgeResponse, "bridgeResponse");
  serializer(errorMessage, "errorMessage");
}
