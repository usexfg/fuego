...
#ifdef __aarch64__
/* ARM64: Use pthreads instead of context switching */
#define USE_PTHREADS_FOR_ARM64
struct mcontext {
  long	mc_onstack;		/* XXX - sigcontext compat. */
  long	mc_x[29];		/* General purpose registers x0-x28 */
  long	mc_fp;			/* Frame pointer x29 */
  long	mc_lr;			/* Link register x30 */
  long	mc_sp;			/* Stack pointer x31 */
  long	mc_pc;			/* Program counter */
  long	mc_spsr;		/* Saved Program Status Register */
  long	mc_pad;			/* padding */
...
#define	_MC_FPOWNED_PCB		0x20002	/* FP state came from PCB */
  long	mc_ownedfp;
  long	mc_fpstate[64];		/* Floating point state */
  long	mc_spare[8];
};
#else
